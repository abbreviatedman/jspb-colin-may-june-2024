...
2. Preview the page in the browser. The HTML file is using the next lesson's final JS, **06.02-Chinese-Zodiac-Animals-FINAL.js**. This gives us a sneak preview of the completed interface, which will require this and the next lessons to code from scratch.
...
13. Reload the page. In the top middle of the section there should be a white box that says _Chinese Zodiac Animal_.
